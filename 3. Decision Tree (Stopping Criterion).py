...
# Recursively constructs the decision tree with maximum depth
...
# Accuracies for Information Gain and Gini Criterion
ig_train_accuracies = []
ig_test_accuracies = []
...
for _ in range(100):
    ...
    # Train and test decision tree with Information Gain
